      ...
      <section className="profile">
        <div className="profile__avatar-container ">
          <div className="profile__avatar-cover">
            <button className="profile__avatar-edit button-zeroing" onClick={handleEditAvatarClick}/>
          </div>
        ...
        <div className="profile__text-about">
          <div className="profile__title-container">
            ...
            <button className="profile__btn-edit button-zeroing transition-opacity" type="button" name="Изменить описание профиля" onClick={handleEditProfileClick}/>
          </div>
          <p className="profile__subtitle text-overflow" name="curAboutUser">Информации о вас пока нет</p>
        </div>
        <button className="profile__btn-add button-zeroing transition-opacity" type="button" name="Добавить место" onClick={handleAddPlaceClick}/>
      </section>
